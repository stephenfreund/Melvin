...
REJECTED = {
    ...
    "post_commit_loop.mml": "after the commit point",
    "post_commit_cas_loop.mml": "after the commit point",
    "post_commit_acquire.mml": "blocking action may not follow the commit point",
